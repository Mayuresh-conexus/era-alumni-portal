                        ...
                        <div class="blog-details__left">
                            <div class="blog-details__img-box">
                                <div class="blog-details__img">
                                    <img src="https://weblayout.unicktheme.com/fistudy/main-html/assets/images/blog/blog-details-img-1.jpg" alt="">
                                </div>
                            </div>
                            <div class="blog-details__content">
                                ...
                                <div class="blog-details__client-and-meta">
                                    <div class="blog-details__client-box">
                                        <div class="blog-details__client-img">
                                            <img src="https://weblayout.unicktheme.com/fistudy/main-html/assets/images/blog/blog-details-client-img-1.jpg" alt="">
                                        </div>
                                ...
                                <div class="blog-details__quote-box">
                                    ...
                                    <div class="blog-details__client-box-2">
                                        <div class="blog-details__client-img-2">
                                            <img src="https://weblayout.unicktheme.com/fistudy/main-html/assets/images/blog/blog-details-client-img-2.jpg" alt="">
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-xl-6 col-lg-6">
                                            <div class="blog-details__img-box-img">
                                                <img src="https://weblayout.unicktheme.com/fistudy/main-html/assets/images/blog/blog-details-img-box-img-1.jpg" alt="">
                                            </div>
                                        </div>
                                        <div class="col-xl-6 col-lg-6">
                                            <div class="blog-details__img-box-img">
                                                <img src="https://weblayout.unicktheme.com/fistudy/main-html/assets/images/blog/blog-details-img-box-img-2.jpg" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <ul class="comment-one__single-list list-unstyled">
                                            ...
                                            <div class="comment-one__single">
                                                <div class="comment-one__image-box">
                                                    <div class="comment-one__image">
                                                        <img src="https://weblayout.unicktheme.com/fistudy/main-html/assets/images/blog/comment-1-1.jpg" alt="">
                                                    </div>
                                                </div>
                                        ...
                                        <li>
                                            <div class="comment-one__single">
                                                <div class="comment-one__image-box">
                                                    <div class="comment-one__image">
                                                        <img src="https://weblayout.unicktheme.com/fistudy/main-html/assets/images/blog/comment-1-2.jpg" alt="">
                                                    </div>
                                                </div>
                                                <div class="comment-one__content">
                                                    <div class="comment-one__name-box">
                                    ...
                                    <ul class="comment-one__single-list comment-one__single-list-2 list-unstyled">
                                        <li>
                                            <div class="comment-one__single">
                                                <div class="comment-one__image-box">
                                                    <div class="comment-one__image">
                                                        <img src="https://weblayout.unicktheme.com/fistudy/main-html/assets/images/blog/comment-1-3.jpg" alt="">
                                                    </div>
                                                </div>
                                                <div class="comment-one__content">
                                                    <div class="comment-one__name-box">
                                ...
                                <div class="comment-form">
                                    ...
                                    <form action="assets/inc/sendemail.php" class="comment-form__form contact-form-validated" novalidate="novalidate">
                                        <div class="row">
                                            <div class="col-xl-6 col-lg-6">
                                                <div class="comment-form__input-box">
                                                    <input type="text" placeholder="Full Name" name="name" fdprocessedid="4cnfk8">
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-6">
                                                <div class="comment-form__input-box">
                                                    <input type="email" placeholder="Email Address" name="email" fdprocessedid="zcnb">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-xl-12">
                                                ...
                                                <div class="comment-form__btn-box">
                                                    <button type="submit" class="comment-form__btn" fdprocessedid="uxsw0r"><span class="icon-arrow-circle"></span>Submit
                                                        Review</button>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="sidebar">
                            <div class="sidebar__single sidebar__search">
                                <div class="sidebar__title-box">
                                    <div class="sidebar__title-icon">
                                        <img src="https://weblayout.unicktheme.com/fistudy/main-html/assets/images/icon/sidebar-title-icon.png" alt="">
                                    </div>
                                ...
                                <form action="#" class="sidebar__search-form">
                                    ...
                                    <button type="submit" fdprocessedid="5okur"><i class="icon-search"></i></button>
                                </form>
                            </div>
                            <div class="sidebar__single sidebar__category">
                                ...
                                <ul class="sidebar__category-list list-unstyled">
                                    <li>
                                        <a href="blog-details.html">Digital Marketing - (45)<span class="fas fa-arrow-right"></span></a>
                                    </li>
                                    <li>
                                        <a href="blog-details.html">Health &amp; Fitness - (12)<span class="fas fa-arrow-right"></span></a>
                                    </li>
                                    <li class="active">
                                        <a href="blog-details.html">Programming &amp; Tech - (78)<span class="fas fa-arrow-right"></span></a>
                                    </li>
                                    <li>
                                        <a href="blog-details.html">Product Design - (45)<span class="fas fa-arrow-right"></span></a>
                                    </li>
                                    <li>
                                        <a href="blog-details.html">Online Chef - (12)<span class="fas fa-arrow-right"></span></a>
                                    </li>
                                </ul>
                            </div>
                                ...
                                <ul class="sidebar__post-list list-unstyled">
                                    <li>
                                        <div class="sidebar__post-image">
                                            <img src="https://weblayout.unicktheme.com/fistudy/main-html/assets/images/blog/blog-lp-1.jpg" alt="">
                                        </div>
                                    ...
                                    <li>
                                        <div class="sidebar__post-image">
                                            <img src="https://weblayout.unicktheme.com/fistudy/main-html/assets/images/blog/blog-lp-2.jpg" alt="">
                                        </div>
                                        <div class="sidebar__post-content">
                                            <ul class="sidebar__post-meta list-unstyled">
                                                <li>
                                    ...
                                    <li>
                                        <div class="sidebar__post-image">
                                            <img src="https://weblayout.unicktheme.com/fistudy/main-html/assets/images/blog/blog-lp-3.jpg" alt="">
                                        </div>
                                        <div class="sidebar__post-content">
                                            <ul class="sidebar__post-meta list-unstyled">
                                                <li>
                            ...
                            <div class="sidebar__single sidebar__newsletter">
                                ...
                                <form action="#" class="sidebar__newsletter-form">
                                    ...
                                    <button type="submit" fdprocessedid="wsgadl">Subscribe<i class="icon-circle-left"></i></button>
                                </form>
                            </div>
                        </div>
                    </div>
